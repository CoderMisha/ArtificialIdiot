...
# map_generated += xml
# xml, next_start = draw_rail_line_with_beats(*next_start, 100)

map_generated += xml
xml, next_start = draw_branch_left(*next_start)

# map_generated += xml
# xml, next_start = draw_rail_line_with_beats(*next_start, 150)
...
map_generated += xml
xml, next_start = draw_rail_line_with_beats(*next_start, 250)
